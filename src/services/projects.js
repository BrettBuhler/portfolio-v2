...
const portfolio = new Project('Portfolio', 'Thank you for visiting my portfolio! I appreciate your interest. Please feel free to reach out to me by clicking the contact button in the top bar. I look forward to connecting with you!', 'Technology: React.js JavaScript, Email.js, Node.js, Google Cloud Platform', 'https://www.brettbuhler.com','https://github.com/BrettBuhler/portfolio-v2', '', portfolioBackground)
